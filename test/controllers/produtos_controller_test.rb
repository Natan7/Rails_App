...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { categoria: @produto.categoria, codigo_id: @produto.codigo_id, data_criacao: @produto.data_criacao, nome: @produto.nome } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { categoria: @produto.categoria, codigo_id: @produto.codigo_id, data_criacao: @produto.data_criacao, nome: @produto.nome } }
